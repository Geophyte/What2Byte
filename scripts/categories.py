...
categories = {'do smarowania': ['dżemy i marmolady', 'kremy', 'pasty'],
              'nabiał': ['jaja i drożdże', 'jogurty i serki', 'mleko i kefir', 'produkty twarogowe', 'sery', 'śmietany'],
              'napoje': None,
              'owoce i orzechy': None,
              'pieczywo': ['bułki', 'chleby', 'tortille', 'zamienniki pieczywa'],
              'produkty gotowe': None,
              'produkty mięsne': ['konserwy i pasztety', 'ryby i owoce morza', 'świeże mięsa', 'wędliny i mięsa w plastrach'],
              'przyprawy i dodatki w proszku': None,
              'sosy i dodatki': ['ketchup, majonez, musztarda', 'Sosy'],
              'spiżarnia': ['do słodzenia', 'kasze i ryż', 'kawa, kakao, herbata', 'makarony', 'mąki', 'ocet', 'produkty zbożowe', 'puszki i słoiki'],
              'tłuszcze': None,
